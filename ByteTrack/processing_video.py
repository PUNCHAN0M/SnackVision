...
if __name__ == "__main__":
    ...
    video_dataset_root = Path("./video_dataset")
    results_root = Path("./results")

    # Find all .avi files recursively
    video_files = list(video_dataset_root.rglob("*.avi"))
    if not video_files:
        print("[ERROR] No .avi files found in ./video_dataset/")
        exit(1)
    ...
    for video_input_path in tqdm(video_files, desc="Processing videos"):
        ...
        # Determine relative path under video_dataset (e.g., "20250915/h00/file.avi")
        try:
        ...
        # Output structure: ./results/{date_folder}/csv/ and /video/
        date_folder = rel_path.parts[0]  # e.g., "20250915"
        csv_output_dir = results_root / date_folder / "csv"
        video_output_dir = results_root / date_folder / "video"
        ...
        csv_output_path = csv_output_dir / f"{video_input_path.stem}.csv"
