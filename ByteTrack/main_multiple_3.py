    ...
    with VideoSink(_video_output_path, video_info) as sink:
        for frame in tqdm(generator, total=video_info.total_frames):
            ...
            detected_objects = model_object(
                frame, conf=0.7, classes=_filter_class_object
            )
...
if __name__ == "__main__":
    ...
    model_person, model_object, class_person_names_dict, class_objects_names_dict = (
        model_initialization(
            model_person_path="./models/yolo11s.pt",
    ...
    video_input_path = Path("./videos/many.avi")
    video_output_path = Path("./results/videos/many_17Sep.avi")
    video_process(
