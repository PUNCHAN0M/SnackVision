...
if __name__ == "__main__":
    ...
    # Adjust CSV output interval (write data every N frames)
    # ProcessingConfig.CSV_OUTPUT_INTERVAL = 150  # Uncomment to write CSV every 150 frames instead of 300

    # Adjust drawing interval (draw annotations every N frames for performance)
    # ProcessingConfig.DRAWING_INTERVAL = 150  # Uncomment to draw every 150 frames instead of 300
